...
const EXPECT_ANALYTICS = process.env.EXPECT_CLOUDFLARE_ANALYTICS === 'true';
...
section('Analytics, fonts and image weight');
{
  ...
  if (EXPECT_ANALYTICS) {
    ...
    check('no production analytics identifier is embedded', !html.includes('static.cloudflareinsights.com'), 'beacon present');
  }
